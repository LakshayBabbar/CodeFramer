  ...
  return (
    <>
      <main className='lg:flex flex-row-reverse'>
        <Image src="/contact.webp" priority width={1000} height={1000} alt='contact us' className='w-1/2 h-screen aspect-square object-cover hidden lg:block' />
        <div className='lg:w-1/2 h-screen place-items-center sm:place-content-center relative'>
          <motion.form
