...
const Footer = () => {
  return (
    <footer className="mt-[10vh] py-5 space-y-5 dark:text-slate-200 text-slate-800 px-10 sm:px-0 w-full sm:w-fit sm:text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 text-slate-300 sm:gap-4 sm:justify-center font-[600]">
        <Link href="/">Home</Link>
      ...
      <p className="font-semibold">© 2024 by CodeFramer. &nbsp;All rights reserved.</p>
    </footer>
  );
};
