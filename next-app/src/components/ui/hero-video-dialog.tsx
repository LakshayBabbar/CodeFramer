...
interface HeroVideoProps {
  ...
  thumbnailSrc?: string;
  thumbnailAlt?: string;
  staticThumnailImage?: StaticImport;
  className?: string;
}
...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        <Image
          src={thumbnailSrc || staticThumnailImage || ""}
          alt={thumbnailAlt}
          className="rounded-md border shadow-lg transition-all duration-200 ease-out brightness-110 group-hover:brightness-[0.8]"
          priority
        />
